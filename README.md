...
A professional, fully responsive **Food Delivery Web Application** built with **HTML5**, **Tailwind CSS (CDN)**, and **Lucide Icons**. Mobile-first design using the _Sunset Orange_ (`#FF4D24`) design system.
...
│   └── menu-manager.php   ← Menu CRUD table + add/edit modal
│
└── admin/
    └── admin-panel.php    ← 📊 Combined analytics + voucher management
```
...
| 10  | **Menu Manager**            | `merchant/menu-manager.php`        | Full CRUD table, search/filter, add/edit modal              |
| 11  | **Admin Panel**             | `admin/admin-panel.php`            | Analytics charts + voucher creation/management              |
...
onboarding.html
  ...
  merchant/merchant-dashboard.html  ←→  merchant/menu-manager.php
  admin/admin-panel.php  (Analytics ↔ Vouchers tabbed)
```
...
_Built with ❤️ by NguyenQuangNhat — FoodRush Platform 2026_
